...
class Flight(models.Model):
    ...
    number = models.CharField(blank = False, null = False,max_length=5, unique=True)
    ...
    priceAdultEC = models.FloatField(blank=False, null=False)
    revenueAdultEC = models.FloatField(blank=False, null=False)

    priceChildrenEC = models.FloatField(blank=False, null=False)
    revenueChildrenEC = models.FloatField(blank=False, null=False)

    priceInfantEC = models.FloatField(blank=False, null=False)
    revenueInfantEC = models.FloatField(blank=False, null=False)    
    ...
    def priceMoney(self) -> str:
        price = self.priceAdultEC + self.revenueAdultEC
...
class Booking(models.Model):
    ...
    flight = models.ForeignKey(Flight,on_delete=models.CASCADE,null=False,blank=False,related_name="booking")
